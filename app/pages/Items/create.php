...
<form action="" method="post" enctype="multipart/form-data">
    <div class="mb-3">
        <label for="exampleFormControlInput1" class="form-label">Ссылка на изображение</label>
        <input type="text" class="form-control" id="exampleFormControlInput1" name="image_url">
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <select class="form-select" id="exampleFormControlInput1" name="category_id">
            <option selected>Выберите категорию</option>
            <option value="1">Кузов</option>
            <option value="2">Двигатель</option>
            <option value="3">Ходовая часть</option>
