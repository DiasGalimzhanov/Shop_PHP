<div style="display: flex; justify-content: center; align-items: center; height: 100%; padding: 100px ">
  <div style="width: calc(100% - 400px); max-width: 100%; margin: 0 300px; box-sizing: border-box;">
    <form action="" method="POST">
        ...
        <input type="text" class="form-control" id="phone_number" name="phone_number" required><br>
        ...
        <div>
        <input class="btn btn-primary" type="submit" value="Зарегистрироваться"><br><br>

        <a class="btn btn-primary" href="/mvc/user/auth" role="button">Авторизация</a>
        </div>
    </form>
  </div>
</div>